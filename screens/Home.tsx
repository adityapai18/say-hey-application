...
const Home = () => {
  ...
  return (
    ...
    <View style={{flex:1,marginTop:40,padding:20}}>
      ...
      <Text h6>WELCOME TO 👋</Text>
      <Text h4 style={{ color: COLORS.primary }}>SayHey!!</Text>
      </View>
     <Image style={{width:55 ,height:60}}
...
/>
  ...
  <View><Text h4>How Are You Feeling Today?</Text></View>
...
/>
  ...
  <View><Text h4>Upcoming Schedule!</Text>
  </View>
  <View>
    <Text h4 style={{ color: COLORS.primary }}>See All</Text>
  </View>
  </View>
  <View style={{flexDirection:"row", justifyContent:"space-between", marginTop:30}}>
  <View><Text h4>Active Professionals</Text>
  </View>
  <View>
    <Text h4 style={{ color: COLORS.primary }}>See All</Text>
  </View>
  ...
  <View style={{flexDirection:"row", justifyContent:"space-between", marginTop:30}}>
  <View><Text h4>Top Rated Professionals</Text>
  </View>
  <View>
    <Text h4 style={{ color: COLORS.primary }}>See All</Text>
  </View>
